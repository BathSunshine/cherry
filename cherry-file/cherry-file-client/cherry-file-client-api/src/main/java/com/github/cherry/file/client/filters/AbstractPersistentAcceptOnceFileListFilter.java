 ...
 *
 */
public abstract class AbstractPersistentAcceptOnceFileListFilter<F> extends AbstractFileListFilter<F> implements
        ReversibleFileListFilter<F>, ResettableFileListFilter<F>, Closeable {
    ...
    /**
     * Flush the store if it's a {@link Flushable} and {@link #setFlushOnUpdate(boolean) flushOnUpdate} is true.
     * 
     * @since 1.4.5
     */

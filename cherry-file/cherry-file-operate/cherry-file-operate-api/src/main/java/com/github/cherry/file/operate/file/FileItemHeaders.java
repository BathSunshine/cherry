...
public interface FileItemHeaders {
    ...
    /**
     * <p>
     * Returns all the values of the specified item header as an <code>Iterator</code> of <code>String</code> objects.
     * </p>
     * <p>
     * If the item did not include any headers of the specified name, this method returns an empty <code>Iterator</code>

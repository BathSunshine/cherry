...
public class HttpUtil {
    ...
    public static String urlEncode(String value, String encoding) {
        ...
        try {
            ...
            throw new IllegalArgumentException(CommonResourceHolder.getInstance().getString("FailedToEncodeUri"), e);
        }
    }
    ...
    public static String urlDecode(String value, String encoding) {
        ...
        try {
            ...
            throw new IllegalArgumentException(CommonResourceHolder.getInstance().getString("FailedToDecodeUrl"), e);
        }
    }

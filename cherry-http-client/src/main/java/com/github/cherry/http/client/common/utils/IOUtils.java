...
import com.github.cherry.http.client.common.io.BoundedInputStream;
import com.github.cherry.http.client.common.io.RepeatableBoundedFileInputStream;
import com.github.cherry.http.client.common.io.RepeatableFileInputStream;
    ...
    public static InputStream newRepeatableInputStream(final InputStream original) throws IOException {
        ...
        if (!original.markSupported()) {
            if (original instanceof FileInputStream) {
                ...
                repeatable = new BufferedInputStream(original, ClientConstants.DEFAULT_STREAM_BUFFER_SIZE);
            }
        } else {
            repeatable = original;
        }

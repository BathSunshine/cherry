 ...
 * <p>
 * This is useful to wrap ServletInputStreams. The ServletInputStream will block if you try to read content from it that
 * isn't there, because it doesn't know whether the content hasn't arrived yet or whether the content has finished. So,
 * one of these, initialized with the Content-length sent in the ServletInputStream's header, will stop it blocking,
 * providing it's been sent with a correct content length.
 *
 * @since 2.1.1
 */
public class BoundedInputStream extends InputStream {
     ...
     *
     * @return {@code true} if calling {@link #close()} propagates to the <code>close()</code> method of the
     ...
     * should propagate to the underling {@link InputStream}.
     *
     * @param propagateClose {@code true} if calling {@link #close()} propagates to the <code>close()</code> method of

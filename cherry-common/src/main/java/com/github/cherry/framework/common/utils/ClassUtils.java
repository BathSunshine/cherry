...
public abstract class ClassUtils {
     ...
     * {@code Class.getResource} by prepending a
     ...
     * directly to {@code ClassLoader.getResource()}. For it to be fed to {@code Class.getResource} instead, a leading
     * slash would also have

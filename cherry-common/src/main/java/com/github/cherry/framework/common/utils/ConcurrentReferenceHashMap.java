...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
     ...
     * collisions. This implementation uses the same Wang/Jenkins algorithm as {@link ConcurrentHashMap}. Subclasses can
     * override to provide alternative hashing.
     * 
    ...
    protected final class Segment extends ReentrantLock {
         ...
         * property should only be set via {@link #setReferences} to ensure that the {@code resizeThreshold} is
         * maintained.
         */
    ...
    protected static final class Entry<K, V> implements Map.Entry<K, V> {
        ...
        public final boolean equals(Object other) {
            ...
            return (ObjectUtils.nullSafeEquals(getKey(), otherEntry.getKey()) && ObjectUtils.nullSafeEquals(getValue(),
                    otherEntry.getValue()));
        }
    ...
    protected class ReferenceManager {
         ...
         * method must be thread safe and ideally should not block when returning {@code null}. References should be
